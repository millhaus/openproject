...
class ActivitiesController < ApplicationController
  ...
  def index
    ...
    if events.empty? || stale?(etag: [@activity.scope, @date_to, @date_from, @with_subprojects, @author, events.first, User.current, current_language, DesignColor.overwritten])
